...
> 当前状态：阶段 1 已独立复验通过；阶段 2 前置问题已消除，S2-008 换边待办语义和 S2-009 特殊结果作废均已通过本地回归、待独立复验。阶段 3 的权威计分事务、心跳/接管、响应未知恢复和场地图裁判工作台已通过本地自动化验收；正式 BWF 规则采用、真机、真人裁判、生产部署和独立复验尚未完成。
...
本轮场地图重构的已执行证据为：定向测试 64/64、`pnpm test` 94/94、Playwright 13/13、lint/typecheck/build 通过、生产启动安全 3/3、知识库同步脚本测试 10/10；375/390/1024 视口和 200% 字体视觉 QA 通过。这些都是 Chromium 浏览器设备模拟证据，不等同于真机验收。
...
| 2 | 计分与双打规则引擎 | 阶段 3 前置问题已消除；S2-008、S2-009 本地回归通过、待独立复验 |
| 3 | 主裁判工作台和多设备权威记分 | 场地图工作台及本地自动化/视觉 QA 通过；真机、真人裁判、正式规则采用、生产部署和独立复验未完成 |
